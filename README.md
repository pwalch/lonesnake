...
```bash
mkdir -p ~/.local/bin && \
  curl -sL -o ~/.local/bin/lonesnake https://raw.githubusercontent.com/pwalch/lonesnake/1.4.0/lonesnake && \
...
```bash
mkdir -p ~/.local/bin && \
  curl -sL -o ~/.local/bin/lonesnake-kit https://raw.githubusercontent.com/pwalch/lonesnake/1.4.0/helpers/lonesnake-kit && \
