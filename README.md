...
```bash
mkdir -p ~/.local/bin && \
  curl -sL -o ~/.local/bin/lonesnake https://raw.githubusercontent.com/pwalch/lonesnake/0.42.0/lonesnake && \
...
```bash
mkdir -p ~/.local/bin && \
  curl -sL -o ~/.local/bin/lonesnake-kit https://raw.githubusercontent.com/pwalch/lonesnake/0.42.0/helpers/lonesnake-kit && \
